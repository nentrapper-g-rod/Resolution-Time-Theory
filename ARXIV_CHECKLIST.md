# arXiv packaging checklist — RTT Core Edition 4.1
...
- [x] Provenance notes N-05–N-11 under results/
- [x] CI workflow present
- [x] Edition 4.1: scoreboard, numerical table, figures, denser related work
...
- [x] Source: `paper/RTT_Core_Edition_4.1.tex`
- [x] Figure generator: `paper/generate_figures.py`
- [ ] Compiled PDF + `paper/figures/` committed (local build available)
...
- [ ] Log in at arxiv.org
- [ ] Primary category: quant-ph (optional secondary: physics.hist-ph)
- [ ] Endorsement if required
- [ ] Upload source + figures and/or PDF
- [ ] Author: Joshua B. Girod (matches CITATION.cff)
...
*Last updated: 2026-07-30 — Core Edition 4.1*
